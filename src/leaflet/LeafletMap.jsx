        ...
        <section className='flex flex-col'>
            <div className='bg-indigo-50 '>
                ...
                <div className='grid grid-cols-2 max-lg:flex max-lg:flex-col'>
                    ...
                    {!loading ?
                        <div className='bg-white rounded-lg my-5 mr-10 max-lg:mx-5 border-[1px] border-black pb-5 max-lg:text-xs'>
                            <div className='flex flex-col px-5 pt-5 mb-3'>
                                <h1 className='font-semibold text-xl max-lg:text-base max-lg:leading-tight max-lg:mb-2'>{data?.filter(e => e.id === regulasi)[0]?.data?.content?.filter(e => e.id_village === village)[0]?.name_village} - {data?.filter(e => e.id === regulasi)[0]?.district}</h1>
